return {
    descriptions = {
        Joker = {
            ...
            j_joy_flady_fire = {
                name = "{C:joy_effect}Fortune Lady Fire",
                text = {
                    {
            ...
            j_joy_flady_wind = {
                name = "{C:joy_effect}Fortune Lady Wind",
                text = {
                    {
            ...
            j_joy_flady_water = {
                name = "{C:joy_effect}Fortune Lady Water",
                text = {
                    {
            ...
            j_joy_flady_earth = {
                name = "{C:joy_effect}Fortune Lady Earth",
                text = {
                    {
            ...
            j_joy_flady_dark = {
                name = "{C:joy_effect}Fortune Lady Dark",
                text = {
                    {
            ...
            j_joy_flady_past = {
                name = "{C:joy_effect}Fortune Lady Past",
                text = {
                    {
            ...
            j_joy_flady_every = {
                name = "{C:joy_synchro}Fortune Lady Every",
                text = {
                    {
            ...
            j_joy_ffairy_hikari = {
                name = "{C:joy_effect}Fortune Fairy Hikari",
                text = {
                    {
            ...
            j_joy_ffairy_en = {
                name = "{C:joy_effect}Fortune Fairy En",
                text = {
                    {
            ...
            j_joy_ffairy_hu = {
                name = "{C:joy_effect}Fortune Fairy Hu",
                text = {
                    {
            ...
            j_joy_ffairy_swee = {
                name = "{C:joy_effect}Fortune Fairy Swee",
                text = {
                    {
                        "{C:chips}+#1#{} Chips for each time a listed",
                        "{C:green}probability{} succeeded this run",
            ...
            j_joy_ffairy_chee = {
                name = "{C:joy_effect}Fortune Fairy Chee",
                text = {
                    {
                        "{C:mult}+#1#{} Mult for each time a listed",
                        "{C:green}probability{} succeeded this run",
            ...
            j_joy_ffairy_ann = {
                name = "{C:joy_effect}Fortune Fairy Ann",
                text = {
                    {
