return {
    descriptions = {
        Joker = {
            j_joy_ltwin_lilla = {
                name = "{C:joy_effect}Live{C:joy_effect,f:joy_font}☆{}{C:joy_effect}Gemela Lil-la",
                text = {
                    {
                        "{C:chips}+#1#{} Chips",
                    },
            ...
            j_joy_ltwin_kisikil = {
                name = "{C:joy_effect}Live{C:joy_effect,f:joy_font}☆{}{C:joy_effect}Gemela Ki-sikil",
                text = {
                    {
                        "{C:mult}+#1#{} Mult",
                    },
            ...
            j_joy_ltwin_lilla_treat = {
                name = "{C:joy_effect}Live{C:joy_effect,f:joy_font}☆{}{C:joy_effect}Gemela Lil-la Dulce",
                text = {
                    {
            ...
            j_joy_ltwin_lilla_sweet = {
                name = "{C:joy_effect}Live{C:joy_effect,f:joy_font}☆{}{C:joy_effect}Gemela Lil-la Golosina",
                text = {
                    {
            ...
            j_joy_ltwin_kisikil_frost = {
                name = "{C:joy_effect}Live{C:joy_effect,f:joy_font}☆{}{C:joy_effect}Gemela Ki-sikil Helada",
                text = {
                    {
            ...
            j_joy_etwin_kisikil_deal = {
                name = "{C:joy_link}Evil{C:joy_link,f:joy_font}★{}{C:joy_link}Gemela Ki-sikil Trato",
                text = {
                    {
                        "{C:mult}+#1#{} Mult",
            ...
            j_joy_etwin_kisikil = {
                name = "{C:joy_link}Evil{C:joy_link,f:joy_font}★{}{C:joy_link}Gemela Ki-sikil",
                text = {
                    {
                        "{C:mult}+#1#{} Mult",
                    },
            ...
            j_joy_etwin_lilla = {
                name = "{C:joy_link}Evil{C:joy_link,f:joy_font}★{}{C:joy_link}Gemela Lil-la",
                text = {
                    {
                        "{C:chips}+#1#{} Chips",
                    },
            ...
            j_joy_etwin_kisikil_lilla = {
                name = "{C:joy_effect}Evil{C:joy_effect,f:joy_font}★{}{C:joy_effect}Gemelas Ki-sikil & Lil-la",
                text = {
                    {
            ...
            j_joy_etwin_sunny = {
                name = "{C:joy_link}Sunny Problemática de Evil{C:joy_link,f:joy_font}★{}{C:joy_link}Gemela",
                text = {
                    {
                        "{C:chips}+#1#{} Chips",
                        "{C:mult}+#2#{} Mult",
            ...
            j_joy_ltwin_channel = {
                name = "Canal {C:joy_spell}Live{C:joy_spell,f:joy_font}☆{}{C:joy_spell}Gemela",
                text = {
                    {
    ...
    misc = {
        dictionary = {
            k_joy_archetype_ltwin = "Live☆Gemela",
        }
    }
}
