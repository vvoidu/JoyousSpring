return {
    descriptions = {
        Joker = {
            j_joy_spright_blue = {
                name = "{C:joy_effect}Azul Spright",
                text = {
                    {
            ...
            j_joy_spright_carrot = {
                name = "{C:joy_effect}Zanahoria Spright",
                text = {
                    {
            ...
            j_joy_spright_red = {
                name = "{C:joy_effect}Roja Spright",
                text = {
                    {
            ...
            j_joy_spright_pixies = {
                name = "{C:joy_effect}Duendecillos Spright",
                text = {
                    {
            ...
            j_joy_spright_sprind = {
                name = "{C:joy_link}Sprind Spright",
                text = {
                    {
            ...
            j_joy_spright_gigantic = {
                name = "{C:joy_xyz}Spright Gigante",
                text = {
                    {
