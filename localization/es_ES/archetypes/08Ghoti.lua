return {
    descriptions = {
        Joker = {
            j_joy_fish_keaf = {
                name = "{C:joy_effect}Keaf, Tinieblas de los Ghoti",
                text = {
                    {
            ...
            j_joy_fish_paces = {
                name = "{C:joy_effect}Paces, Luz de los Ghoti",
                text = {
                    {
                        "{C:chips}+#1#{} Chips",
                    },
            ...
            j_joy_fish_shif = {
                name = "{C:joy_effect}Shif, Hada de los Ghoti",
                text = {
                    {
                        "{C:mult}+#1#{} Mult",
                    },
            ...
            j_joy_fish_zep = {
                name = "{C:joy_effect}Zep, Rubí de los Ghoti",
                text = {
                    {
                        "{C:attention}Banishes{} at the end of round",
                        "until {C:attention}Blind{} is selected and",
            ...
            j_joy_fish_ixeep = {
                name = "{C:joy_effect}Ixeep, Augurio de los Ghoti",
                text = {
                    {
                        "{C:attention}Banishes{} at the end of round",
            ...
            j_joy_fish_eanoc = {
                name = "{C:joy_effect}Eanoc, Centinela de los Ghoti",
                text = {
                    {
                        "{C:attention}Banishes{} at the end of round",
                        "until {C:attention}Blind{} is selected",
            ...
            j_joy_fish_psiics = {
                name = "{C:joy_effect}Psiics, Luz de Luna de los Ghoti",
                text = {
                    {
                        "{C:attention}Banishes{} at the end of round",
            ...
            j_joy_fish_snopios = {
                name = "{C:joy_effect}Snopios, Sombra de los Ghoti",
                text = {
                    {
            ...
            j_joy_fish_arionpos = {
                name = "{C:joy_synchro}Arionpos, Serpiente de los Ghoti",
                text = {
                    {
            ...
            j_joy_fish_askaan = {
                name = "{C:joy_synchro}Askaan, el Ghoti Bicornio",
                text = {
                    {
            ...
            j_joy_fish_guoglim = {
                name = "{C:joy_synchro}Guoglim, Lanza de los Ghoti",
                text = {
                    {
            ...
            j_joy_fish_deepbeyond = {
                name = "{C:joy_synchro}Ghoti del Profundo Más Allá",
                text = {
                    {
            ...
            j_joy_fish_depths = {
                name = "{C:joy_spell}El Más Distante, Profundísima Profundidad",
                text = {
                    {
