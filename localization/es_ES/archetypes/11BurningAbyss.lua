return {
    descriptions = {
        Joker = {
            j_joy_ba_alich = {
                name = "{C:joy_effect}Alich, Malebranche del Abismo Ardiente",
                text = {
                    {
            ...
            j_joy_ba_barbar = {
                name = "{C:joy_effect}Barbar, Malebranche del Abismo Ardiente",
                text = {
                    {
                        "{C:mult}+#1#{} Mult",
            ...
            j_joy_ba_cagna = {
                name = "{C:joy_effect}Cagna, Malebranche del Abismo Ardiente",
                text = {
                    {
                        "{C:chips}+#1#{} Chips",
                    },
            ...
            j_joy_ba_calcab = {
                name = "{C:joy_effect}Calcab, Malebranche del Abismo Ardiente",
                text = {
                    {
            ...
            j_joy_ba_cir = {
                name = "{C:joy_effect}Cir, Malebranche del Abismo Ardiente",
                text = {
                    {
            ...
            j_joy_ba_draghig = {
                name = "{C:joy_effect}Draghig, Malebranche del Abismo Ardiente",
                text = {
                    {
            ...
            j_joy_ba_farfa = {
                name = "{C:joy_effect}Farfa, Malebranche del Abismo Ardiente",
                text = {
                    {
            ...
            j_joy_ba_graff = {
                name = "{C:joy_effect}Graff, Malebranche del Abismo Ardiente",
                text = {
                    {
            ...
            j_joy_ba_libic = {
                name = "{C:joy_effect}Libic, Malebranche del Abismo Ardiente",
                text = {
                    {
                        "Destroys itself if you own a non-{C:joy_normal}Fiend{}",
                        "{C:joy_normal}Monster{} {C:attention}Joker{} when {C:attention}Blind{} is selected",
            ...
            j_joy_ba_rubic = {
                name = "{C:joy_effect}Rubic, Malebranche del Abismo Ardiente",
                text = {
                    {
                        "Destroys itself if you own a non-{C:joy_normal}Fiend{}",
                        "{C:joy_normal}Monster{} {C:attention}Joker{} when {C:attention}Blind{} is selected",
            ...
            j_joy_ba_scarm = {
                name = "{C:joy_effect}Scarm, Malebranche del Abismo Ardiente",
                text = {
                    {
                        "Destroys itself if you own a non-{C:joy_normal}Fiend{}",
                        "{C:joy_normal}Monster{} {C:attention}Joker{} when {C:attention}Blind{} is selected",
            ...
            j_joy_ba_malacoda = {
                name = "{C:joy_ritual}Malacoda, Bajoseñor del Abismo Ardiente",
                text = {
                    {
            ...
            j_joy_ba_cherubini = {
                name = "{C:joy_link}Querubiní, Ángel de Ébano del Abismo Ardiente",
                text = {
                    {
            ...
            j_joy_ba_dante = {
                name = "{C:joy_xyz}Dante, Viajero del Abismo Ardiente",
                text = {
                    {
                    ...
                    {
                        "{C:joy_xyz}Detach{} {C:attention}#3#{}: Sends {C:attention}#4#{}",
            ...
            j_joy_ba_pilgrim = {
                name = "{C:joy_fusion}Dante, Peregrino del Abismo Ardiente",
                text = {
                    {
                        "{C:blue}+#1#{} Hands",
                        "{C:red}+#2#{} Discards",
            ...
            j_joy_ba_virgil = {
                name = "{C:joy_synchro}Virgilio, Estrella de Rock del Abismo Ardiente",
                text = {
                    {
            ...
            j_joy_ba_beatrice = {
                name = "{C:joy_xyz}Beatriz, la Dama Eterna",
                text = {
                    {
    ...
    misc = {
        dictionary = {
            k_joy_archetype_ba = "Abismo Ardiente",
        }
    }
}
