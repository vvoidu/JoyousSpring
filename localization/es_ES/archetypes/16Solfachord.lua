return {
    descriptions = {
        Joker = {
            j_joy_solfa_cutia = {
                name = "{C:joy_pendulum_effect}Cutia DoSolfacorde",
                joy_consumable = {
            ...
            j_joy_solfa_dreamia = {
                name = "{C:joy_pendulum_effect}Dreamia ReSolfacorde",
                joy_consumable = {
            ...
            j_joy_solfa_eliteia = {
                name = "{C:joy_pendulum_effect}Eliteia MiSolfacorde",
                joy_consumable = {
            ...
            j_joy_solfa_fancia = {
                name = "{C:joy_pendulum_effect}Fancia FaSolfacorde",
                joy_consumable = {
            ...
            j_joy_solfa_gracia = {
                name = "{C:joy_pendulum_effect}Gracia SolSolfacorde",
                joy_consumable = {
            ...
            j_joy_solfa_angelia = {
                name = "{C:joy_pendulum_effect}Angelia LaSolfacorde",
                joy_consumable = {
            ...
            j_joy_solfa_beautia = {
                name = "{C:joy_pendulum_effect}Beautia SiSolfacorde",
                joy_consumable = {
            ...
            j_joy_solfa_coolia = {
                name = "{C:joy_pendulum_effect}Coolia DoSolfacorde",
                joy_consumable = {
            ...
            j_joy_solfa_musecia = {
                name = "{C:joy_link}Gransolfacorde Musecia",
                text = {
                    {
            ...
            j_joy_solfa_grancoolia = {
                name = "{C:joy_link}Gransolfacorde Coolia",
                text = {
                    {
            ...
            j_joy_solfa_harmonia = {
                name = "{C:joy_spell}Armonía Solfacorde",
                text = {
                    {
    ...
    misc = {
        dictionary = {
            k_joy_archetype_solfa = "Solfacorde",
        }
    }
}
