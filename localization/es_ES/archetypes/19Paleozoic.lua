return {
    descriptions = {
        Joker = {
            j_joy_paleo_canadia = {
                name = "{C:joy_trap}Canadia Paleozoico",
                text = {
                    {
            ...
            j_joy_paleo_dino = {
                name = "{C:joy_trap}Dinomischus Paleozoico",
                text = {
                    {
            ...
            j_joy_paleo_eldonia = {
                name = "{C:joy_trap}Eldonia Paleozoico",
                text = {
                    {
            ...
            j_joy_paleo_hallu = {
                name = "{C:joy_trap}Hallucigenia Paleozoico",
                text = {
                    {
            ...
            j_joy_paleo_lean = {
                name = "{C:joy_trap}Leanchoilia Paleozoico",
                text = {
                    {
            ...
            j_joy_paleo_marrella = {
                name = "{C:joy_trap}Marrella Paleozoico",
                text = {
                    {
            ...
            j_joy_paleo_oleno = {
                name = "{C:joy_trap}Olenoides Paleozoico",
                text = {
                    {
            ...
            j_joy_paleo_pikaia = {
                name = "{C:joy_trap}Pikaia Paleozoico",
                text = {
                    {
            ...
            j_joy_paleo_cambro = {
                name = "{C:joy_link}Cambroraster Paleozoico",
                text = {
                    {
            ...
            j_joy_paleo_anomalo = {
                name = "{C:joy_xyz}Anomalocaris Paleozoico",
                text = {
                    {
            ...
            j_joy_paleo_opa = {
                name = "{C:joy_xyz}Opabinia Paleozoico",
                text = {
                    {
    ...
    misc = {
        dictionary = {
            k_joy_archetype_paleo = "Paleozoico",
        }
    }
}
