return {
    descriptions = {
        Joker = {
            j_joy_danger_jack = {
                name = "{C:joy_effect}¿¡Peligro!? ¿Lebrílope?",
                text = {
                    {
            ...
            j_joy_danger_tsuch = {
                name = "{C:joy_effect}¿¡Peligro!? ¿Tsuchinoko?",
                text = {
                    {
            ...
            j_joy_danger_chup = {
                name = "{C:joy_effect}¡Peligro! ¡Chupacabras!",
                text = {
                    {
            ...
            j_joy_danger_moth = {
                name = "{C:joy_effect}¡Peligro! ¡Hombre Polilla!",
                text = {
                    {
                        "{C:red}+#1#{} Discards",
            ...
            j_joy_danger_dog = {
                name = "{C:joy_effect}¡Peligro! ¡Hombre Perro!",
                text = {
                    {
                    ...
                    {
                        "Adds {C:attention}#3#{} {C:joy_normal}\"Danger!\"{} to the shop",
                        "when destroyed by a {C:joy_normal}\"Danger!\"{} ability",
                    },
                }
            },
            j_joy_danger_ness = {
                name = "{C:joy_effect}¡Peligro! ¡Nessie!",
                text = {
                    {
            ...
            j_joy_danger_big = {
                name = "{C:joy_effect}¡Peligro! ¡Pie Grande!",
                text = {
                    {
            ...
            j_joy_danger_ogo = {
                name = "{C:joy_effect}¡Peligro! ¡Ogopogo!",
                text = {
                    {
            ...
            j_joy_danger_thunder = {
                name = "{C:joy_effect}¡Peligro! ¡Pájaro del Trueno!",
                text = {
                    {
            ...
            j_joy_danger_realm = {
                name = "{C:joy_spell}Reino del ¡Peligro!",
                text = {
                    {
                        "Destroys a random {C:attention}Joker{} when {C:attention}Blind{} is selected",
                        "and gives {C:money}+$#1#{}",
            ...
            j_joy_danger_disorder = {
                name = "{C:joy_spell}¡Peligro! ¡Disturbio! ¡Desorden!",
                text = {
                    {
    ...
    misc = {
        dictionary = {
            k_joy_archetype_danger = "¡Peligro!",
        }
    }
}
