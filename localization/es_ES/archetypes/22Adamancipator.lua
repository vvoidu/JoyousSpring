return {
    descriptions = {
        Joker = {
            j_joy_adaman_analyzer = {
                name = "{C:joy_effect}Analizador Adamancipador",
                text = {
                    {
            ...
            j_joy_adaman_researcher = {
                name = "{C:joy_effect}Investigadora Adamancipador",
                text = {
                    {
                        "{C:attention}Excavate{} and check the top {C:attention}#1#{}:",
            ...
            j_joy_adaman_seeker = {
                name = "{C:joy_effect}Buscador Adamancipador",
                text = {
                    {
                        "{C:attention}Excavate{} and check the top {C:attention}#1#{}:",
            ...
            j_joy_adaman_crysdragite = {
                name = "{C:joy_effect}Cristal Adamancipador - Dragónito",
                text = {
                    {
            ...
            j_joy_adaman_crysraptite = {
                name = "{C:joy_effect}Cristal Adamancipador - Rapázita",
                text = {
                    {
                        "Each {C:diamonds}Diamond{} held in hand gives",
            ...
            j_joy_adaman_crysleonite = {
                name = "{C:joy_effect}Cristal Adamancipador - Leónito",
                text = {
                    {
                        "Each {C:diamonds}Diamond{} held in hand gives",
            ...
            j_joy_adaman_dragite = {
                name = "{C:joy_synchro}Despertado Adamancipador - Dragónito",
                text = {
                    {
                        "{C:attention}Excavate{} and check the top {C:attention}#1#{}:",
            ...
            j_joy_adaman_leonite = {
                name = "{C:joy_synchro}Despertado Adamancipador - Leónito",
                text = {
                    {
                        "{C:attention}Excavate{} and check the top {C:attention}#1#{}:",
            ...
            j_joy_adaman_raptite = {
                name = "{C:joy_synchro}Despertado Adamancipador - Rapázita",
                text = {
                    {
                        "{C:attention}Excavate{} and check the top {C:attention}#1#{}:",
            ...
            j_joy_adaman_laputite = {
                name = "{C:joy_spell}Lapudita Adamancipador",
                text = {
                    {
    ...
    misc = {
        dictionary = {
            k_joy_archetype_adaman = "Adamancipador",
        }
    }
}
