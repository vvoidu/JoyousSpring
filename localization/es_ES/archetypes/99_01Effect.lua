return {
    descriptions = {
        Joker = {
            j_joy_boarder = {
                name = "{C:joy_effect}Inspector Surfista",
                text = {
                    {
            ...
            j_joy_rhino = {
                name = "{C:joy_effect}Guerrero Rinoceronte Demoníaco",
                text = {
                    {
            ...
            j_joy_tourguide = {
                name = "{C:joy_effect}Guía Turística del Inframundo",
                text = {
                    {
            ...
            j_joy_heavenlyprison = {
                name = "{C:joy_effect}Señor de la Prisión Celestial",
                text = {
                    {
            ...
            j_joy_backup = {
                name = "{C:joy_effect}Secretaria de Respaldo",
                text = {
                    {
            ...
            j_joy_wizard = {
                name = "{C:joy_effect}Mago Ciberso",
                text = {
                    {
            ...
            j_joy_formud = {
                name = "{C:joy_effect}Salta Formatos",
                text = {
                    {
            ...
            j_joy_procession = {
                name = "{C:joy_effect}Procesión del Tarro de Té",
                text = {
                    {
            ...
            j_joy_darkcat = {
                name = "{C:joy_effect}Gato Oscuro con Cola Blanca",
                text = {
                    {
                        "{C:mult}+#1#{} Mult",
                    },
            ...
            j_joy_dekoichi = {
                name = "{C:joy_effect}Dekoichi la Locomotora Encantada",
                text = {
                    {
                        "{C:mult}+#1#{} Mult,",
            ...
            j_joy_bokoichi = {
                name = "{C:joy_normal}Bokoichi el Coche Que Asusta",
                text = {
                    {
            ...
            j_joy_desertapir = {
                name = "{C:joy_effect}Tapir del Desierto",
                text = {
                    {
            ...
            j_joy_searchlight = {
                name = "{C:joy_effect}Hombrereflector",
                text = {
                    {
                        "{C:mult}+#1#{} Mult,",
            ...
            j_joy_sternmystic = {
                name = "{C:joy_effect}El Místico Severo",
                text = {
                    {
                        "{C:chips}+#1#{} Chips,",
            ...
            j_joy_mof = {
                name = "{C:joy_effect}Mago de la Fe",
                text = {
                    {
            ...
            j_joy_mask = {
                name = "{C:joy_effect}Máscara de la Oscuridad",
                text = {
                    {
            ...
            j_joy_angraecum = {
                name = "{C:joy_effect}Paraguas Angraecum",
                text = {
                    {
            ...
            j_joy_eater = {
                name = "{C:joy_effect}Devorador de Millones",
                text = {
                    {
            ...
            j_joy_miradora = {
                name = "{C:joy_effect}Céfiro Celestial - Miradora",
                text = {
                    {
            ...
            j_joy_beautunaful = {
                name = "{C:joy_effect}Princesa Bellatún",
                text = {
                    {
            ...
            j_joy_leaffish = {
                name = "{C:joy_effect}Pez Hoja sin Vida",
                text = {
                    {
            ...
            j_joy_ringowurm = {
                name = "{C:joy_effect}Ringosierpe, el Dragón Guarda de las Cien Manzanas",
                text = {
                    {
            ...
            j_joy_token_ringo = {
                name = "{C:joy_token}Ficha Cien Manzanas",
                text = {
                    {
            ...
            j_joy_stormshooter = {
                name = "{C:joy_effect}Tirador de Tormentas",
                text = {
                    {
            ...
            j_joy_ghostbird = {
                name = "{C:joy_effect}Pájaro Fantasma del Embrujo",
                text = {
                    {
            ...
            j_joy_tiamaton = {
                name = "{C:joy_effect}Dragón de Hierro Tiamaton",
                text = {
                    {
            ...
            j_joy_zenoguitar = {
                name = "{C:joy_effect}Xenoguitar Banda de Rock",
                text = {
                    {
            ...
            j_joy_revgolem = {
                name = "{C:joy_effect}Gólem de la Reanimación",
                text = {
                    {
            ...
            j_joy_tackcrusader = {
                name = "{C:joy_effect}Cruzado Derribador",
                text = {
                    {
            ...
            j_joy_blockdragon = {
                name = "{C:joy_effect}Dragón de Bloques",
                text = {
                    {
            ...
            j_joy_elfobia = {
                name = "{C:joy_effect}Hada Fantasma Elfobia",
                text = {
                    {
            ...
            j_joy_elfuria = {
                name = "{C:joy_effect}Hada Mística Elfuria",
                text = {
                    {
            ...
            j_joy_lindbloom = {
                name = "{C:joy_effect}Lindflorecido",
                text = {
                    {
            ...
            j_joy_genomix = {
                name = "{C:joy_effect}Luchador Genomix",
                text = {
                    {
            ...
            j_joy_maxsix = {
                name = "{C:joy_effect}Seis como Máximo",
                text = {
                    {
            ...
            j_joy_stpolice = {
                name = "{C:joy_effect}Policía del Espacio-Tiempo",
                text = {
                    {
            ...
            j_joy_merchant = {
                name = "{C:joy_effect}Mercader Mágico",
                text = {
                    {
            ...
            j_joy_catoblepas = {
                name = "{C:joy_effect}Catoblepas y la Bruja del Destino",
                text = {
                    {
            ...
            j_joy_coupleofaces = {
                name = "{C:joy_effect}Pareja de Ases",
                text = {
                    {
