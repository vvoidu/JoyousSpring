    ...
    descriptions = {
        Joker = {
            j_joy_firewall_saber = {
                name = "{C:joy_synchro}Dragón Sable Cortafuego",
                text = {
                    {
            ...
            j_joy_bishbaalkin = {
                name = "{C:joy_synchro}Señor Fantasmal Ultimitl Bishbaalkin",
                text = {
                    {
            ...
            j_joy_token_utchatzimime = {
                name = "{C:joy_token}Fichas Utchatzimime",
                text = {
                    {
            ...
            j_joy_fishlamp = {
                name = "{C:joy_synchro}Lámpara Pez",
                text = {
                    {
            ...
            j_joy_token_lamp = {
                name = "{C:joy_token}Ficha Lámpara",
                text = {
                    {
                        "This card can be used as any {C:joy_token}Token{}",
                    },
            ...
            j_joy_afd = {
                name = "{C:joy_synchro}Dragón Hada Antiguo",
                text = {
                    {
