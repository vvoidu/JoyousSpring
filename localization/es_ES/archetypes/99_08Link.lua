return {
    descriptions = {
        Joker = {
            j_joy_apollousa = {
                name = "{C:joy_link}Apollousa, Arco de la Diosa",
                text = {
                    {
            ...
            j_joy_beyond = {
                name = "{C:joy_link}Más Allá del Péndulo",
                text = {
                    {
            ...
            j_joy_exceed = {
                name = "{C:joy_link}Sobrepasa el Péndulo",
                text = {
                    {
            ...
            j_joy_ipmasq = {
                name = "{C:joy_link}I:P Enmascarada",
                text = {
                    {
            ...
            j_joy_spknight = {
                name = "{C:joy_link}S:P Pequeña Caballera",
                text = {
                    {
