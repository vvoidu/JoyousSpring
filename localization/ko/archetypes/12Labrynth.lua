    ...
    descriptions = {
        Joker = {
            j_joy_lab_clock = {
                ...
                text = {
                    {
                        "이 카드를 {C:attention}릴리스{}할 시 손패의 무작위 카드 {C:attention}#1#{}장을",
                        "{C:attention}뒷면{}으로 뒤집고 영구히 {C:mult}+#2#{} 배수를",
                        "부여한뒤 손패를 섞습니다",
                        "그 후, {C:blue}일반{} {C:joy_normal}\"라뷰린스\"{} 조커를",
                        "최대 {C:attention}#3#{}장 {C:attention}소생{}시킵니다",
                        "{C:inactive}(\"라뷰린스 쿠클락\" 제외){}",
                    },
                },
            },
            j_joy_lab_stovie = {
                ...
                text = {
                    {
                        "이 카드와 다른 조커 한 장을 {C:attention}릴리스{}할 시",
                        "손패의 무작위 카드 {C:attention}#1#{}장을",
                        "{C:attention}뒷면{}으로 뒤집어 영구히",
                        "칩 {C:chips}+#2#{}개를 부여한뒤 손패를 섞습니다",
                ...
                text = {
                    {
                        ...
                        "뒤집어 영구히 {C:money}+$#2#{}를 부여한뒤 손패를 섞습니다",
            ...
            j_joy_lab_ariane = {
                ...
                text = {
                    ...
                    },
                    {
                        ...
                        "다음 {C:attention}블라인드{}에서의 손패",
                        "크기를 {C:attention}+#2#{}장 증가시킵니다",
                    },
                    {
                        "이 카드를 보유한 도중",
                        "한 라운드 안에 {C:attention}#3#{}장 이상의",
                        "카드를 뒤집었을경우,",
                        "다음 상점에 {C:green}희귀 {C:joy_normal}\"라뷰린스\"{}",
                        "카드 한 장을 추가합니다",
            ...
            j_joy_lab_arianna = {
                ...
                text = {
                    ...
                    },
                    {
                        ...
                        "한 라운드 안에 {C:attention}#3#{}장 이상의",
                        "카드를 뒤집었을경우",
                        "다음 상점에 {C:blue}일반 {C:joy_normal}\"라뷰린스\"{}",
                        "카드 한 장을 추가합니다",
                        "{s:0.9,C:inactive}(현재 #4#장)",
                    },
                },
            ...
            j_joy_lab_arias = {
                ...
                text = {
                    ...
                    {
                        "이 카드를 보유한 도중 한 라운드 안에 {C:attention}#3#{}장 이상의",
            ...
            j_joy_lab_archfiend = {
                ...
                text = {
                    ...
                    {
                        "플레잉 카드가 {C:attention}뒤집힐때{}, 다른",
                        "무작위한 카드를 {C:attention}뒷면으로 뒤집고{} 패를 섞습니다",
                    },
                },
            },
            j_joy_lab_lovely = {
