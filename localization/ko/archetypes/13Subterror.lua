return {
    descriptions = {
        Joker = {
            ...
            j_joy_sub_warrior = {
                ...
                text = {
                    ...
                    },
                    {
                        ...
                        "{C:joy_normal}\"서브테러마리스\"{} 카드 {C:attention}#2#{}장을 생성합니다",
                    },
                },
            },
            j_joy_sub_guru = {
                ...
                text = {
                    {
                        ...
                        "{s:0.9,C:inactive}(이 효과는 뒷면일 경우에도 발동합니다)",
                    },
                    {
            ...
            j_joy_sub_phos = {
                name = "{C:joy_effect}서브테러마리스 글래이오스",
                text = {
                    {
            ...
            j_joy_sub_volt = {
                name = "{C:joy_effect}서브테러마리스 볼티니아",
                text = {
                    {
                        "뒷면인 카드 한 장 마다",
                        "{C:mult}+#1#{} 배수를 획득합니다",
            ...
            j_joy_sub_speleo = {
                ...
                text = {
                    {
                        "이 카드의 배수 획득량은 카드가",
                        "{C:attention}뒤집힐 때마다{} {X:mult,C:white}X#1#{} 증가합니다",
                        "{s:0.9,C:inactive}(이 효과는 뒷면일 경우에도 증가합니다)",
